...
def read_body_and_headers(url, post=None, headers=[], follow_redirects=False, timeout=None):
    ...
    if len(headers) == 0: headers.append(
    ...
    if cj is not None:  # we successfully imported # one of the two cookie handling modules
        ...
        if os.path.isfile(ficherocookies):
            ...
            try:
                cj.load(
                    ficherocookies)  # if we have a cookie file already saved # then load the cookies into the Cookie Jar
            except:
        ...
        if cookielib is not None:
            ...
            if not follow_redirects:
                ...
                opener = urllib.request.build_opener(urllib.request.HTTPHandler(debuglevel=Http_debug_log_enabled),
                                                     urllib.request.HTTPCookieProcessor(cj))
...
def killxbmc():
    ...
    if myplatform == 'osx':
        ...
        try:
            ...
            pass
        message(ADDONTITLE,
                "If you\'re seeing this message it means the force close was unsuccessful. Please force close XBMC/Kodi [COLOR=lime]DO NOT[/COLOR] exit cleanly via the menu.")
        ...
        message(
            ADDONTITLE,
            "Press the HOME button on your remote and [COLOR=red][B]FORCE STOP[/B][/COLOR] KODI via the Manage "
            "Installed Applications menu in settings on your Amazon home page then re-launch KODI")
        ...
        try:
            ...
            pass
        message(ADDONTITLE,
                "If you\'re seeing this message it means the force close was unsuccessful. Please force close "
                "XBMC/Kodi [COLOR=lime]DO NOT[/COLOR] exit cleanly via the menu.",
        ...
        message(ADDONTITLE,
                "If you\'re seeing this message it means the force close was unsuccessful. Please force close "
                "XBMC/Kodi [COLOR=lime]DO NOT[/COLOR] exit via the menu.",
                "iOS detected.  Press and hold both the Sleep/Wake and Home button for at least 10 seconds, "
